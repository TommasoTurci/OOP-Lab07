...
public class Sport2SocialNetworkUserImpl<U extends User> extends SocialNetworkUserImpl<U> {
     ...
     */
    	public Set<Sport> getIndividualSports() {	
    		Set<Sport> individuals = new TreeSet<>();
    		for (Sport s : usports) {if (s.isIndividualSport()) individuals.add(s);}
    		return individuals;
    	}
     ...
     */
    	...
    	public Set<Sport> getSportPracticedInPlace(Place p) {	
    		Set<Sport> placed = new TreeSet<>();
    		for (Sport s : usports) {if (s.getPlace()==p) placed.add(s);}
    		return placed;
    	}
